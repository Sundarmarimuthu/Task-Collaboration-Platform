...
import { UserIcon, CalendarIcon, FlagIcon } from './Icons';
...
const priorityStyles: { [key in Priority]: { bg: string; text: string; icon: string } } = {
...
const TaskCard: React.FC<TaskCardProps> = ({ task, onEditTask }) => {
  ...
  // To prevent invalid date strings from crashing the app
